...
public class WelcomePaeTransit {
    JFrame frame;//Creating object of JFrame
    JLabel image = new JLabel(new ImageIcon(this.getClass().getResource("/trainwp4.png")));//Creating object of JLabel and adding image using the ImageIcon class
    JLabel text=new JLabel ("WELCOME ABOARD!!");
    JProgressBar progressBar=new JProgressBar();
    JLabel message=new JLabel();
    WelcomePaeTransit()//Creating constructor of the class
    {
        createGUI();
        addImage();
        addText();
    ...
    public void createGUI(){
        ...
        frame.getContentPane().setBackground(Color.pink);//setting background color
    ...
    public void addText()
    {
        ...
        text.setForeground(Color.BLACK);//Setting foreground color
